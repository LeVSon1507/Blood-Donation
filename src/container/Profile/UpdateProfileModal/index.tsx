              ...
              <Grid xs={12} mb={2} gap={1}>
                <Autocomplete
                  ...
                  onChange={(_, option: any) => {
                    ...
                    setListDistricts(
                      getListDistrictsByProvinceCode(option?.value)
                    );
                  }}
                  value={
                    values?.city
                      ? getAllProvinces().find(
                          (i) => i.value === values?.city?.toString()
                        )
                      : null
                  }
                />
              ...
              <Grid xs={12} mb={2} gap={1}>
                <Autocomplete
                  ...
                  value={
                    values?.district
                      ? listDistricts.find(
                          (i) => i.value === values?.district?.toString()
                        )
                      : null
                  }
                />
              ...
              <Grid xs={12} mb={2} gap={1}>
                <Autocomplete
                  ...
                  value={
                    values?.ward
                      ? listWards.find(
                          (i) => i.value === values?.ward?.toString()
                        )
                      : null
                  }
                />
